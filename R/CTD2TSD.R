...
CTD2TSD <- function(f=NULL, outfile=NULL, hpr0=NULL, Pain=FALSE, vessel=list()){
	...
	#
	############ VARIABLES: ############
	# ---f--- is the CTD file in cnv format.
	# ---outfile--- is file to which the CTD data are written.
	# ---hpr0--- is the pressure at sea level, which must be given externally. Defaulted to 101325 pascal.
