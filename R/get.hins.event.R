...
#'
get.hins.event<-function(con=NULL, event=33, cruise=2009116, t=c("20091115084000", "20091115085000"), turns=114, k=5, q=c(1e3, 1e2), beta_school=2e-4, ind=list(-(1:100), NULL), max.memory=2e9, ...){
