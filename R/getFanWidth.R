...
#'
#' @param data		The list of inputs variables as returned from read.TSD (including ).
...
#' @param stretch	Used to stretch the voxels of the ME70 multibeam echosounder in the direction of motion, so that space in between voxels is smoothed out.
#' @param range		The range at which this stretch value is as desired
#' @param ind		The indices of the beams to treat (such as data$rect).
#'
#' @return
#'
#' @examples
...
#' @rdname getFanWidth
#'
getFanWidth <- function(data, fanWidth, stretch=1, range=0, ind=NULL){
